...
public final class LogUtil {
        ...
        if ((sToggleRelease && logType >= INFO)
            ...
            switch (logType) {
                case ERROR:
                    ...
                    nativeE(tagStr, msgStr.toString());
                    break;
                case WARN:

                    nativeW(tagStr, msgStr.toString());
                    break;
                case INFO:

                    nativeI(tagStr, msgStr.toString());
                    break;
                case DEBUG:

                    nativeD(tagStr, msgStr.toString());
                    break;
                case VERBOSE:

                    nativeV(tagStr, msgStr.toString());
                    break;
                default:
                    break;
            }
    ...
    private static  void nativeE(String tagStr,String msgStr){
        if(Build.TYPE != null){
            android.util.Log.e(tagStr, msgStr);
        }else{
            println(tagStr,msgStr);
        }

    }

    private static void nativeW(String tagStr,String msgStr){
        if(Build.TYPE != null){
            android.util.Log.w(tagStr, msgStr);
        }else{
            println(tagStr,msgStr);
    ...
    private static void nativeI(String tagStr,String msgStr){
        if(Build.TYPE != null){
            android.util.Log.i(tagStr, msgStr);
        }else{
            println(tagStr,msgStr);
    ...
    private static void nativeD(String tagStr,String msgStr){
        if(Build.TYPE != null){
            android.util.Log.d(tagStr, msgStr);
        }else{
            println(tagStr,msgStr);
        }
    }

    private static void nativeV(String tagStr,String msgStr){
        if(Build.TYPE != null){
            android.util.Log.v(tagStr, msgStr);
        }else{
            println(tagStr,msgStr);
        }
    }

    private static void println(String tagStr,String msgStr){
        System.out.println(tagStr+":"+msgStr);
    }
